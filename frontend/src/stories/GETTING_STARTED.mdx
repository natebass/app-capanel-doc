...
Use the `src/stories` folder for Storybook stories and supporting component docs.

## Quick links

1. [Chakra UI cards details](/)
2. [Developer Guide components page](https://opensacorg.github.io/learning-blocks-doc/developer-guide/components>
3. [Developer Guide Storybook page](https://opensacorg.github.io/learning-blocks-doc/developer-guide/storybook>
